...
if numberOfGuesses == 0:
    ...
    message = "Well done! You get in " + str(numberOfGuesses) + " guesses. <a href=''>Play again</a>"
else:    
    message = "You have " + str(reds) + " Correct digit(s) in the right place, and " + str(whites) + "correct digits(s) in the wrong place. You have had " + str(numberOfGuesses) + "guess(es)."
